...
/* PHP build date */
#define PHP_BUILD_DATE "2014-01-03"

/* hardcode for each of the cross compiler host */
#define PHP_OS "Darwin"

/* hardcode for each of the cross compiler host */
#define PHP_UNAME "Darwin fouber-mac.mshome.net 13.0.0 Darwin Kernel Version 13.0.0: Thu Sep 19 22:22:27 PDT 2013; root:xnu-2422.1.72~6/RELEASE_X86_64 x86_64"
